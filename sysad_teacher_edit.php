...
<body>
  ...
  <nav class="breadcrumb is-centered" aria-label="breadcrumbs">
    <ul>
      ...
      <li><a href="sysad_teacher.php">Teacher Management</a></li>
      <li class="is-active" aria-current="page"><a href=".php">Edit Teacher</a></li>
    </ul>
  </nav>
    ...
    <div class="container">
      <div class="columns">
        ...
        <div class="column">
          <div class="box">
            <div class="content">
              <h1>Teacher Management : Edit</h1>
              <form class="" action="edit.php" method="POST">
                <?php
                $q = "SELECT * FROM teacher WHERE teacher.idteacher = ".$_GET['id'].";";
                ...
                foreach ($row as $key => $value) {
                 ...
                 <div class="field is-grouped is-grouped-centered">
                   ...
                   <p class="control"><a href="sysad_teacher.php" class="button">Back</a></p>
                 </div>
                 <input type="hidden" name="totable" value="teacher">
              </form>
