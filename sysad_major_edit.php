...
<body>
  ...
  <nav class="breadcrumb is-centered" aria-label="breadcrumbs">
    <ul>
      ...
      <li><a href="sysad_major.php">major Management</a></li>
      <li class="is-active" aria-current="page"><a href=".php">Edit major</a></li>
    </ul>
  </nav>
    ...
    <div class="container">
      <div class="columns">
        ...
        <div class="column">
          <div class="box">
            <div class="content">
              <h1>major Management : Edit</h1>
              <form class="" action="edit.php" method="POST">
                <?php
                $q = "SELECT * FROM major WHERE major.idmajor = ".$_GET['id'].";";
                ...
                foreach ($row as $key => $value) {
                 ...
                 <div class="field is-grouped is-grouped-centered">
                   ...
                   <p class="control"><a href="sysad_major.php" class="button">Back</a></p>
                 </div>
                 <input type="hidden" name="totable" value="major">
              </form>
