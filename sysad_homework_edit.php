...
<body>
  ...
  <nav class="breadcrumb is-centered" aria-label="breadcrumbs">
    <ul>
      ...
      <li><a href="sysad_homework.php">homework Management</a></li>
      <li class="is-active" aria-current="page"><a href=".php">Edit homework</a></li>
    </ul>
  </nav>
    ...
    <div class="container">
      <div class="columns">
        ...
        <div class="column">
          <div class="box">
            <div class="content">
              <h1>homework Management : Edit</h1>
              <form class="" action="edit.php" method="POST">
                <?php
                $q = "SELECT * FROM homework WHERE homework.idhomework = ".$_GET['id'].";";
                ...
                foreach ($row as $key => $value) {
                 ...
                 <div class="field is-grouped is-grouped-centered">
                   ...
                   <p class="control"><a href="sysad_homework.php" class="button">Back</a></p>
                 </div>
                 <input type="hidden" name="totable" value="homework">
              </form>
