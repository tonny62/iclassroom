...
<body>
  ...
  <nav class="breadcrumb is-centered" aria-label="breadcrumbs">
    <ul>
      ...
      <li class="is-active" aria-current="page"><a href=".php">Teacher Management</a></li>
    </ul>
  </nav>
        ...
        <div class="column">
          <div class="box">
            <div class="content">
              ...
              <form class="" action="sysad_teacher.php" method="post">
              ...
              <?php if (isset($_POST['searchentry'])): ?>
                <table>
                  ...
                  while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='sysad_teacher_edit.php?id=".$row['idteacher']."' class='button is-danger is-outlined'>Edit</a></td>";
                    echo "<td><a href='delete.php?id=".$row['idteacher']."&table=teacher' class='button is-danger'>Delete</a></td>";
